...
# - 'gat': Original attention-based (more expressive, more parameters, slower)
# - 'gcn': Simpler convolution (fewer parameters, faster, better generalization)
# - 'multiscale': Multi-scale GCN (captures 1-hop, 2-hop, 3-hop patterns)

GNN_TYPE = 'gat'  # Change this to switch architectures!
...
optimizer = torch.optim.AdamW(model.parameters(), 
                              lr=0.002,  # 0.002 → 0.0015 (more conservative)
                              weight_decay=1e-5,  
                              betas=(0.9, 0.999))
